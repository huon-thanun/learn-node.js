    ...
    <div class="my-5">
      ...
      <div class="table-responsive shadow-sm rounded-3 border table-wrapper">
        <table class="table table-striped table-hover align-middle mb-0">
          ...
          <tbody>
            <tr v-if="loading">
              <td colspan="5" class="text-center py-4 text-muted"><p class="spinner-border text-danger"><span class="text-primary">Loading...</span></p></td>
            </tr>
            ...
            <tr v-for="p in products" v-else :key="p.id">
              ...
              <td>
                <div class="d-flex justify-content-center gap-2">
                  <button class="btn btn-sm btn-info text-white action-btn" @click="showDetail(p.id)">Detail</button>
                  <button class="btn btn-sm btn-warning text-dark action-btn" @click="startUpdate(p)">Update</button>
                  <button class="btn btn-sm btn-danger action-btn" @click="deleteProduct(p.id)">Delete</button>
                </div>
              </td>
            </tr>
          </tbody>
